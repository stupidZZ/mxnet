...
namespace mxnet {
  namespace op {
    ...
    namespace deformablepsroipool {
      ...
      enum DeformablePSROIPoolingOpOutputs { kOut };
    }  // deformablepsroipool
    ...
    struct DeformablePSROIPoolingParam : public dmlc::Parameter<DeformablePSROIPoolingParam> {
      ...
      DMLC_DECLARE_PARAMETER(DeformablePSROIPoolingParam) {
        ...
        DMLC_DECLARE_FIELD(pad_mode).set_default(false).describe("for each part, pad out of image part or not");
    ...
    public:
      ...
      virtual void Forward(const OpContext &ctx,
        ...
        DeformablePSROIPoolForward(out, data, bbox, trans, param_.no_trans, param_.spatial_scale, param_.output_dim, 
          param_.group_size, param_.pooled_size, param_.part_size, param_.sample_per_part, param_.trans_std, param_.pad_mode);
      }
      ...
      virtual void Backward(const OpContext &ctx,
        ...
        DeformablePSROIPoolBackwardAcc(grad_in, grad_trans, grad_out, data, bbox, trans, param_.no_trans,
          param_.spatial_scale, param_.output_dim, param_.group_size, param_.pooled_size, param_.part_size,
          param_.sample_per_part, param_.trans_std, param_.pad_mode);
